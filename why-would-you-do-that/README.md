...
#### Old version of the code can be found here: [Evolutionary Game and its Pygame simulation](https://github.com/ayucd/why-would-you-do-that/blob/main/evolgame_by_conceited_altruists.py)
